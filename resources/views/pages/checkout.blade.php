                        ...
                        <div class="member mt-3">
                            ...
                            <form class="form-inline" method="post" action="{{ route('checkout-create', $item->id) }}">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    <input type="text" class="form-control datepicker" name="doe_passport" id="doe_passport" style="width: 120px;" placeholder="DOE Passport">
                                </div>
                            ...
                            <p class="disclaimer mb-0">
                                You are only able to invite member that has registered in Venture.
                            </p>
                        </div>
                    </div>
                </div>
